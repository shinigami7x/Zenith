...
set "ACTIVATION_SCRIPT=%DOCUMENTS%\Zenith\MAS_AIO.cmd"
...
echo Launching Windows activation script...
call "%ACTIVATION_SCRIPT%" /HWID /S
if errorlevel 1 goto :error
echo Windows activation script finished running.
